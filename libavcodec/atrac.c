                                ...
                                int num_samples, float *out)
{
    ...
    printf("gc_scale: %.6f", gc_scale);
    printf("gc_now.num_points: %d", gc_now->num_points);
    ...
    if (!gc_now->num_points) {
        ...
        for (i = 0; i < gc_now->num_points; i++) {
            printf("i: %d", i);
            printf("gctx->loc_scale: %d", gctx->loc_scale);
            printf("gc_now->loc_code[i]: %d", gc_now->loc_code[i]);
            printf("gc_now->loc_code[i + 1]: %d", gc_now->loc_code[i + 1]);
            printf("gctx->id2exp_offset: %d", gctx->id2exp_offset);
